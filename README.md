...
Download **CPharmSetup.exe** from the [Releases](../../releases) page and run it (if you change the wizard or installer packaging, push to GitHub so CI produces a new build for testing).
